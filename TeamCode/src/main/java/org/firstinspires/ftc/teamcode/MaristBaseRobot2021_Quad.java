...
public class MaristBaseRobot2021_Quad {
    ...
    public MaristBaseRobot2021_Quad () {
    ...
    public void init(HardwareMap ahwMap) {
        ...
        capping = hwMap.servo.get("capping");
        capping.setPosition(1);
